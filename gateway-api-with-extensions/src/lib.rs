...
mod tests {
    ...
    use crate::common::{ParentReference, ParentRouteStatus, RouteStatus};
    use crate::{
        common::GatewayStatusListeners,
        constants::{
        ...
        gateways::{Gateway, GatewayListeners, GatewaySpec, GatewayStatus, GatewayStatusAddresses},
        grpcroutes::GrpcRouteSpec,
    ...
    async fn test_resource_deployment(client: kube::Client) -> Result<(), Error> {
        ...
        let mut http_route = crate::httproutes::HTTPRoute {
            metadata: ObjectMeta::default(),
            spec: HttpRouteSpec {
        ...
        let mut grpc_route = crate::grpcroutes::GRPCRoute {
            metadata: ObjectMeta::default(),
            spec: GrpcRouteSpec {
        ...
        let mut ref_grant = crate::referencegrants::ReferenceGrant {
            metadata: ObjectMeta::default(),
    ...
    async fn deploy_crds(client: kube::Client) -> Result<(), Error> {
        ...
        let mut http_route_crd = crate::httproutes::HTTPRoute::crd();
        ...
        let mut grpc_route_crd = crate::grpcroutes::GRPCRoute::crd();
        ...
        let mut ref_grant_crd = crate::referencegrants::ReferenceGrant::crd();
